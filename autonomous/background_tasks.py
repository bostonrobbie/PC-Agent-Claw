...
class BackgroundTaskManager:
    ...
    def start_workers(self):
        ...
        print(f"[BACKGROUND] Started {self.max_workers} workers")
    ...
    def stop_workers(self):
        ...
        self.workers = []
        print("[BACKGROUND] Stopped workers")
    ...
    def _execute_task(self, task_id: int, worker_id: int):
        ...
        print(f"[WORKER-{worker_id}] Executing task {task_id}: {task['task_type']}")
        ...
        try:
            ...
            print(f"[WORKER-{worker_id}] Task {task_id} completed: {result.get('success', False)}")
...
def main():
    ...
    print("=" * 70)
    print("Self-Initiated Background Tasks")
    print("=" * 70)
    ...
    try:
        ...
        print(f"\n[OK] Background Task System Working!")
